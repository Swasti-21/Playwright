...
public class InputFromSubmit {
    ...
    public void testInputFormSubmit() throws UnsupportedEncodingException {
        ...
        nameField.fill("SwastiRanjan");
        page.fill("#inputEmail4", "swasti@test.com");
        page.fill("#inputPassword4", "82459851");
        ...
        page.fill("#inputCity", "Secunderabad");
        page.fill("#inputAddress1", "Nampally");
        page.fill("#inputAddress2", "N/A");
        page.fill("#inputState", "Telangana");
        page.fill("#inputZip", "500001");
